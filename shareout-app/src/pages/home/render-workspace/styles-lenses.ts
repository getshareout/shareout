...
.wsx-skill__doc { font: 400 var(--text-sm)/1.65 var(--font-body); color: var(--color-text); } .wsx-skill__doc h1, .wsx-skill__doc h2, .wsx-skill__doc h3 { margin: 16px 0 6px; font-weight: 650; line-height: 1.3; } .wsx-skill__doc h1 { font-size: var(--text-lg); } .wsx-skill__doc h2 { font-size: var(--text-base); } .wsx-skill__doc h3 { font-size: var(--text-sm); } .wsx-skill__doc p, .wsx-skill__doc ul { margin: 0 0 10px; } .wsx-skill__doc ul { padding-left: 20px; } .wsx-skill__doc code { font: var(--text-xs) var(--font-mono, ui-monospace, monospace); background: var(--color-surface); padding: 1px 5px; border-radius: var(--radius-sm); } .wsx-skill__doc pre { margin: 0 0 12px; padding: 10px 12px; overflow: auto; border-radius: var(--radius-md); background: var(--color-surface); } .wsx-skill__doc pre code { background: none; padding: 0; } .wsx-skill__doc blockquote { margin: 0 0 10px; padding-left: 12px; border-left: 3px solid var(--color-border); color: var(--color-text-secondary); } .wsx-skill__doc a { color: var(--color-primary); }
.wsx-skill__changes { display: flex; flex-direction: column; gap: 10px; }
.wsx-field--inline { flex-direction: row; align-items: center; gap: 10px; } .wsx-field--inline .wsx-field__in { flex: 1; }
